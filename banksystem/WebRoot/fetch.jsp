...
<body>
	...
	<div class="sidebar-fixed" id="sidebar">
		...
		<ul class="nav nav-list">
			...
			<li><a href="deleteUserInfo.jsp"> <i
	...
	<div id="content">
		<div class="panel panel-default toggle">
			...
			<div class="panel-heading">
				<h3 class="panel-title">取钱</h3>
			</div>
			<div class="panel-body">
				<form action="fmoneyValidate.action"
					class="form-horizontal group-border hover-stripped" role="form">
					<s:token />
					<div class="form-group">
						<label class="col-lg-2 col-md-2 col-sm-12 control-label">输入取款金额</label>
